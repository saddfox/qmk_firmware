...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_B] = LAYOUT( /* Base */
        QK_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,    KC_EQL,  KC_BSPC, KC_INS, _______,
    ...
    [WIN_FN] = LAYOUT( /* Fn */
        ...
        _______, GU_TOGG, _______,                   _______,                                     _______, _______, NXT_LED, UG_VALD, PRV_LED),
};
